...
class TestBox(Driver):
    ...
    def input_full_name(self, value):
        ...
        assert self.get_full_name_field().text == value
    ...
    def input_email(self, value):
        ...
        assert self.get_email_field().text == value
    ...
    def input_current_address(self, value):
        ...
        assert self.get_current_address_field().text == value
    ...
    def input_permanent_address(self, value):
        ...
        assert self.get_permanent_address_field().text == value
    ...
    def output_field_check_values(self, name=None, email=None, current_address=None, permanent_address=None):
        ...
        if current_address:
            assert output_field.find_element(By.XPATH, '//*[@id="currentAddress"]').text == f'Current Address :{current_address}'
        if permanent_address:
            assert output_field.find_element(By.XPATH, '//*[@id="permanentAddress"]').text == f'Permananet Address :{permanent_address}'